...
# ===================== Files =====================
RADICAL_FILES = {
    "Hydroxyl radical (·OH)": r"H:/研究生学习（人工智能+环境）/论文学习/ML：氧化剂与污染物降解-PAA/数据库小论文/分类后独立文件_终极优化版/Hydroxyl_radical_ultimate.csv",
    "Sulfate radical (SO4•−)": r"H:/研究生学习（人工智能+环境）/论文学习/ML：氧化剂与污染物降解-PAA/数据库小论文/分类后独立文件_终极优化版/Sulfate_radical_ultimate.csv",
    "Carbonate radical (CO3•−)": r"H:/研究生学习（人工智能+环境）/论文学习/ML：氧化剂与污染物降解-PAA/数据库小论文/分类后独立文件_终极优化版/Carbonate_radical_ultimate.csv",
    "Ozone (O3)": r"H:/研究生学习（人工智能+环境）/论文学习/ML：氧化剂与污染物降解-PAA/数据库小论文/分类后独立文件_终极优化版/Ozone_ultimate.csv",
    "Free chlorine (HOCl/OCl−)": r"H:/研究生学习（人工智能+环境）/论文学习/ML：氧化剂与污染物降解-PAA/数据库小论文/分类后独立文件_终极优化版/FreeChlorine_ultimate.csv",
    "Chlorine radical (Cl•)": r"H:/研究生学习（人工智能+环境）/论文学习/ML：氧化剂与污染物降解-PAA/数据库小论文/分类后独立文件_终极优化版/ChlorineRadical_ultimate.csv",
    "Dichlorine radical (Cl2•−)": r"H:/研究生学习（人工智能+环境）/论文学习/ML：氧化剂与污染物降解-PAA/数据库小论文/分类后独立文件_终极优化版/DichlorineRadical_ultimate.csv",
}
